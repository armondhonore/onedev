...
**Live:** [https://relaxed-weasel-onedev.cloud.nexlayer.ai](https://relaxed-weasel-onedev.cloud.nexlayer.ai)  
...
**onedev** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/1dev/server:latest
    path: /
    servicePorts:
    - 6610
    volumes:
